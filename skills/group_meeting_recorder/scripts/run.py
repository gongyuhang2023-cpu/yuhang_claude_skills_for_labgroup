#!/usr/bin/env python3
"""
Universal runner for Meeting PPT Capture skill scripts
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nAvailable scripts:")
        print("  capture.py    - Capture Teams meeting slides")
        sys.exit(1)
    ...
    # Set UTF-8 encoding and unbuffered output for long-running process
    env = os.environ.copy()
